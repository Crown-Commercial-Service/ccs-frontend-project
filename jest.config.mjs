import { packageResolveToPath } from '@ccs-frontend/lib/names'
...
const config = {
  ...
  modulePathIgnorePatterns: [
    '<rootDir>/dist/',
    '<rootDir>/packages/ccs-frontend/dist/'
  ],
 ...
 */
export default {
  collectCoverageFrom: ['./packages/ccs-frontend/src/**/*.{js,mjs}'],
  coverageProvider: 'v8',
  ...
  projects: [
    ...
    },
    {
      ...
      testEnvironment: '@ccs-frontend/helpers/jest/environment/puppeteer.mjs',
      testMatch: [
      ...
      globalSetup: '@ccs-frontend/helpers/jest/browser/open.mjs',
      globalTeardown: '@ccs-frontend/helpers/jest/browser/close.mjs'
    },
    {
      ...config,
      displayName: 'Accessibility tests',
      setupFilesAfterEnv: ['@ccs-frontend/helpers/jest/matchers.js'],
      testEnvironment: '@ccs-frontend/helpers/jest/environment/puppeteer.mjs',
