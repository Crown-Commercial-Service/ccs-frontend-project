  ...
  describe('Plugins', () => {
    describe('CCS Frontend version', () => {
      ...
      it('Adds build type for NODE_ENV=development', async () => {
        ...
        await Declaration['--ccs-frontend-version'](property)
    ...
    describe('Sass syntax parser', () => {
      it.each([
        {
          from: 'src/ccs/components/header/_header.scss',
          to: 'dist/ccs/components/header/_header.scss'
        }
      ])('Adds plugins for $from', ({ from, to }) => {
        const config = configFn({ from, to })
