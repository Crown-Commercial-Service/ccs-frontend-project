...
describe('Browser tasks: Puppeteer browser downloader', () => {
  ...
  it('downloads with single version outdated', async () => {
    browsers = [
      {
        path: '/path/to/ccs-frontend/.cache/puppeteer/chrome/mac-old-version',
        browser: 'chrome',
        platform: 'mac',
        buildId: 'old-version'
      }
  ...
  it('downloads with multiple versions outdated', async () => {
    browsers = [
      {
        path: '/path/to/ccs-frontend/.cache/puppeteer/chrome/mac-old-version-1',
        browser: 'chrome',
        platform: 'mac',
        buildId: 'old-version-1'
      },
      {
        path: '/path/to/ccs-frontend/.cache/puppeteer/chrome/mac-old-version-2',
        browser: 'chrome',
        platform: 'mac',
  ...
  it('download skipped when up-to-date', async () => {
    browsers = [
      {
        path: '/path/to/ccs-frontend/.cache/puppeteer/chrome/mac-new-version',
        browser: 'chrome',
        platform: 'mac',
        buildId: 'new-version'
      }
